	...
	function zTreeOnClick(event, treeId, treeNode) {
		...
		{	
			setTimeout(function(){
					...
					//设备服务器转码推流接口
					$.post("http://user.hddvs.net:8080/apiv2/PushCloudRtmpAction.php", 
							{
...
$(document).ready(function(){
	...
	$('#stopbtn').click(function(){
		...
		//设备服务器转码推流接口, 停止服务器推流
		$.post("http://user.hddvs.net:8080/apiv2/StopCloudRtmpAction.php", 
				{
					"username":"<?php echo $_SESSION['username']; ?>",
					"access_token":"<?php echo $_SESSION['access_token'];?>",
					"state":"<?php echo $_SESSION['state']; ?>",
...
<body style="margin:0 auto">
	...
	<table border='1' width="850px">
        <tr>
            <td colspan=2><h2>服务器转码推流</h2><br/>用户名:<?php echo $_SESSION['username'];?><br/> 访问token:<?php echo $_SESSION['access_token'];?><br/> 访问state:<?php echo $_SESSION['state'];?></td>
        </tr>
        <tr height="400px">
